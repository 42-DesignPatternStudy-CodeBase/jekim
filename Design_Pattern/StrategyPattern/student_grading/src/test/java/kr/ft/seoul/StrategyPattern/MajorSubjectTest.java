...
public class MajorSubjectTest extends TestBaseClass {
    int testMax = 1000;
    ...
    @Test
    public void MajorSubjectTest_creation_Positive_name()
    {
        for (int i = 0; i < testMax; i++)
        {
            int score = 100;
            String name = getRandomString(8);
            Subject subject = new Subject(name, score, true);
    ...
    @Test
    public void MajorSubjectTest_isMajor_Positive()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_isMajor_Negative()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Positive_S()
    {
        for (int i = 0; i < testMax; i++)
        {
            int score = getRandomInt(95, 100);
            Subject subject = new Subject("Korean", score, true);

            assertEquals(score, subject.getScore());
            assertTrue(isDefinitlyEqualsString("S", subject.getGrade()) == true);
        }
    }

    @Test
    public void MajorSubjectTest_score_Positive_A()
    {
        for (int i = 0; i < testMax; i++)
        {
            int score = getRandomInt(90, 94);
            Subject subject = new Subject("Korean", score, true);
    ...
    @Test
    public void MajorSubjectTest_score_Positive_B()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Positive_C()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Positive_D()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Positive_F()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Negative_S()
    {
        for (int i = 0; i < testMax; i++)
        {
            ...
            assertEquals(score, subject.getScore());
            assertTrue(isDefinitlyEqualsString("S", subject.getGrade()) == false);
        }
    }

    @Test
    public void MajorSubjectTest_score_Negative_A()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Negative_B()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Negative_C()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Negative_D()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_score_Negative_F()
    {
        for (int i = 0; i < testMax; i++)
        {
    ...
    @Test
    public void MajorSubjectTest_Exception_00()
    {
        ...
        for (int i = 0; i < testMax; i++)
        {
            ...
            Subject subject = new Subject("English", score, true);
        }
    }

    @Test
    public void MajorSubjectTest_Exception_01()
    {
        expectedException.expect(GradeException.class);
        expectedException.expectMessage(expectedExceptionMessage);
        for (int i = 0; i < testMax; i++)
